...
void DataBase::RequestToDB(QString request, QTableView *view, int requestType)
{
    ...
    switch (requestType) {
        ...
        case requestComedy:{
            ...
            query_model->setHeaderData(0, Qt::Horizontal, tr("Title"));
            query_model->setHeaderData(1, Qt::Horizontal, tr("Description"));
        ...
        case requestAllFilms:{
            ...
            table_model->select();
            table_model->setHeaderData(1, Qt::Horizontal, tr("Title"));
            table_model->setHeaderData(2, Qt::Horizontal, tr("Description"));
